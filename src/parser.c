...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [aux_sym_resource_repeat2] = STATE(43),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__value, 1),
  ...
  [95] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dictionary, 4),
  ...
  [105] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dictionary, 3),
  [107] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_name, 2, .production_id = 1),
  [109] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array, 2),
  [111] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_constructor, 3),
  [113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dictionary, 2),
  [115] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_resource, 1),
  [117] = {.entry = {.count = 1, .reusable = true}}, SHIFT(2),
  [119] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section, 3),
  ...
  [126] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section, 4),
  [128] = {.entry = {.count = 1, .reusable = true}}, SHIFT(16),
  [130] = {.entry = {.count = 1, .reusable = true}}, SHIFT(33),
  [132] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_resource_repeat1, 2),
  [134] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_resource_repeat1, 2), SHIFT_REPEAT(86),
  [137] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__properties, 2),
  [139] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__properties, 2), SHIFT_REPEAT(86),
  ...
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_resource_repeat2, 2),
  [154] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_resource_repeat2, 2), SHIFT_REPEAT(68),
  [157] = {.entry = {.count = 1, .reusable = true}}, SHIFT(67),
  [159] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_resource, 2),
  [161] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_property, 3),
  [163] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_arguments_repeat1, 2), SHIFT_REPEAT(9),
  [166] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_arguments_repeat1, 2),
  ...
  [180] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_array_repeat1, 2), SHIFT_REPEAT(10),
  [183] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pair, 3),
  [185] = {.entry = {.count = 1, .reusable = true}}, SHIFT(20),
  [187] = {.entry = {.count = 1, .reusable = true}}, SHIFT(78),
  [189] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_dictionary_repeat1, 2), SHIFT_REPEAT(8),
  [192] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_dictionary_repeat1, 2),
  ...
  [214] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__type_args, 4),
  ...
  [222] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__type_args, 3),
};
